...
//				new PlayerInfo(new ReferenceShipPlacerWrapper(new se1.schiffeVersenken.ais.voidQualityNew.AICreator()), "new voidQuality();"),
...
//				new PlayerInfo(new ReferenceShipPlacerWrapper(new ReferencePlayerCreator())),
